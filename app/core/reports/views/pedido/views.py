...
from core.pedido.forms import SearchForm
...
'''REPORTE 001'''
class RptPedido001ReportView(ModuleMixin, FormView):
	template_name = 'pedido/reports/rpt_pedido001.html'
	...
	def post(self, request, *args, **kwargs):
		...
		try:
			if action == 'report':
				data = []	
				date_range = request.POST['date_range'] if 'date_range' in request.POST else None
				habilita_fecha = request.POST['habilita_fecha'] if 'habilita_fecha' in request.POST else None			
				if habilita_fecha:
